...
export const stepsEn  = (setWatcher, setFormData) => [
  {
    id: '0',
    component: <CustomStep 
    legend={'Hello, everything okay? So we can start, I need some <strong>quick</strong> information 🙂'}
    textButton={'Yes, I want more information ➡️'}
    />,
    delay: 3000
  },
  {
